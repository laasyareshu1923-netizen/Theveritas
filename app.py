...
# 1. Page Configuration Setup (Wide Dark Layout)
st.set_page_config(
...
# Custom Interactive CSS Framework (Green GO, Slate Clear, and Blue Option Links)
st.markdown("""
    <style>
...
# 5. Search Bar and Core Action Buttons (Fixed layout parameters)
